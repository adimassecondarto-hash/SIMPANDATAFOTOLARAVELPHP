...
<div class="top-form">
    <div class="top-title">isi bagian upload foto</div>

    <form action="{{ route('rekapstudidanujian.store') }}" 
          method="POST" 
        ...
        <div class="top-wrapper">
            ...
            <div class="upload-form">
                <div class="upload-title">upload foto studi</div>
                <input type="file" name="foto_kartu_studi" accept=".pdf" required>
            </div>
...
<table class="data-table">
    <thead>
        <tr>
            <th>foto kartu ujian kampus</th>
            <th>Foto kartu studi kampus</th>
        </tr>
    </thead>
    <tbody>
